...
struct x86_op_mem {
	uint segment; // segment register (or X86_REG_INVALID if irrelevant)
	uint base;	// base register (or X86_REG_INVALID if irrelevant)
	uint index;	// index register (or X86_REG_INVALID if irrelevant)
